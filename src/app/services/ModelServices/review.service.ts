...
export class ReviewService {
    ...
    public Reply(comment: string, reviewId: string): Observable<CustomResponse<string>> {
        const params = new HttpParams().set("comment", comment).set("reviewId", reviewId);
        return this.http.post<CustomResponse<string>>(`${this.baseUrl}Reply`, null, { params: params });
    }
    //#endregion
    ...
    public DeleteReply(reviewId: string, replyId: string): Observable<CustomResponse<string & boolean>> {
        const params = new HttpParams().set("reviewId", reviewId).set("replyId", replyId);
        return this.http.delete<CustomResponse<string & boolean>>(`${this.baseUrl}DeleteReply`, { params: params });
    }
    //#endregion
}
